...
client_id = 'xqkpM485MZ7dFKe7ZNcPvw'
yelp_api_key = 'oexy5lwsWlyWjd8cz7DGSwikSDcvexAgLYoMJ0FihR3YU4jT_1GF-89A229eastv7EFWZ1AoVe19b7d7YOGJ2wqcq2jywW2ynsD1_LxZK1DzpC8CQesOq87kNzjNWnYx'
ticket_api_key = 'JRUxF6Y07LRtD6UApJklVEpl1dhFe3Gk'
...
def interactive_prompt():
    ...
    #     state_abbr = response[1].upper()
    #     yelp_call = city + ', ' + state_abbr

        # if city in city_lst0:
        #     get_from_yelp("food", yelp_call)
        #
        #     get_ticketmaster_data(city)

            # init_db(_DBNAME, _CSV)
    #     else:
    #         print("Please enter a valid city and state abbreviation")
    #         # continue
    # except:
...
#     response = ''
#     while response != 'exit':
#         response = input('Please enter a command. Type "help" for more instructions : ')
#         try:
...
#     get_ticketmaster_data(60614)
#     init_db(DBNAME, CSV)
#     interactive_prompt(all_cities_lst)
...
# Call for Data
#----------------
# get_from_yelp("food", "Chicago, IL")
# get_ticketmaster_data("Chicago")
# init_db(DBNAME, CSV)
